        ...
        <form action='{{ route('full.store') }}' method='post'>
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='id_buku' value="{{ Session::get('id_buku')}}" id="id_buku">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="id_kategori" class="col-sm-2 col-form-label">ID Kategori</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='id_kategori' value="{{ Session::get('id_kategori')}}" id="id_kategori">
                    </div>
                </div>    
                <div class="mb-3 row">
